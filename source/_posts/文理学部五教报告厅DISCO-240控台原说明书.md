---
title: 文理学部五教报告厅DISCO 240控台原说明书
date: 2023-12-26 16:53:06
tags:
- SDC
---
...
> $\text{DISCO 240}$ 为国际标准 $\text{DMX512}$ 信号输出，为了更好的使用和发挥 $\text{DISCO 240}$ 电脑灯控制台的特点，在操作使用前，请仔细参阅说明书。

*可以不用那么仔细，自认为[第十一页](#section-10)相对重要。*
...
目前实践经验较少，大部分功能还未经过实地验证。由于五教当地原因，很多灯处于损坏状态。使用者还需根据实际情况，选择性学习、使用控台功能，以能够确保演出顺利、最大可能满足演出需求为标准。
